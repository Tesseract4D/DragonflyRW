...
import cn.tesseract.dragonfly.asm.HookInjectorFactory.MethodEnter;
import cn.tesseract.dragonfly.asm.HookInjectorFactory.MethodExit;
...
public class AsmHook implements Cloneable, Comparable<AsmHook> {
    ...
    protected void createMethod(HookInjectorClassVisitor classVisitor) {
        ClassMetadataReader.MethodReference superMethod = ClassMetadataReader.findVirtualMethod(getTargetClassInternalName(), targetMethodName, targetMethodDescription);
